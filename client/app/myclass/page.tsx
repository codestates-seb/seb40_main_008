...
const getTakingClasses = async (): Promise<Array<ICategorySearchResult>> => {
	...
	try {
		// request url : https://pioneroroom.com/auth/myclass/takingclass
		// request url : https://pioneroroom.com/auth/myclass/wishclass
...
const MyclassPage = async () => {
	...
	// console.log('🚀MYCLASSPAGE ~ file: page.tsx ~ line 44 ~ page ~ userInfo', userInfo);
